...
object Main extends App {
  ...
  val file_path = "graphDatasets/com-youtube.ungraph.csv"
  ...
  val file_path_v = "graphDatasets/yt_target.csv"
...
//  res.foreach(println)
  ...
  val estimatedTime1 = (System.currentTimeMillis - startTime1) / 1000.0
  println("Time: " + estimatedTime1 + " s")
